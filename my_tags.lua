...
my_tags = {
    ...
    twitch = surfing_screen_tags[12 + screen_1_offset],
    ...
    ipython3 = work_screen_tags[12 + screen_2_offset],
    ipython2 = work_screen_tags[11 + screen_2_offset],
    mindmeister = planning_screen_tags[5 + screen_3_offset],
    meistertask = planning_screen_tags[5 + screen_3_offset],
